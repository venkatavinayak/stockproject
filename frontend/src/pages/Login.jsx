...
const Login = () => {
  ...
  const clerkAppearance = {
    ...
    elements: {
      ...
      socialButtonsBlockButton: "w-full rounded-2xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-white hover:bg-indigo-50 dark:hover:bg-indigo-950/60 font-bold py-4 px-4 transition-all cursor-pointer shadow-md flex items-center justify-center gap-3 hover:border-indigo-500 hover:shadow-indigo-500/20",
      socialButtonsBlockButtonText: "font-extrabold text-base text-slate-800 dark:text-slate-200",
      footer: "hidden border-none p-0 m-0",
      footerAction: "hidden",
